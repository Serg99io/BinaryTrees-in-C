//With a few slight adjustments (like removing double occurences) this code is from: https://gist.github.com/VictorGarritano/5f894be162d39e9bdd5c
...
int main()
{
    ...
    clock_t t1 = clock();
    printf("Step 10:inorder Traversal of rb-tree  Is :\n");
    inorder(root);
    printf("\n");
